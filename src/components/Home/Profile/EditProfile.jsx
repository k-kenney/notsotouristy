...
const EditProfile = ({ editModal, setEditModal, getUserData }) => {
  ...
  return (
    <Modal modal={editModal} setModal={setEditModal}>
      <div className="center w-[95%] md:w-[45rem] bg-white mx-auto shadows my-[1rem] z-30 mb-[3rem] p-[2rem]">
        {/* head */}
          ...
          <div className="flex gap-[2rem]">
            <div className="w-[5rem]">
              <img
                ...
                src={imgUrl ? imgUrl : form.userImg ? form.userImg : "/blank-profile.png"}
                alt="blank profile"
              />
              <input
                onChange={(e) => {
        ...
        <section className="pt-[1rem] text-sm">
          ...
          <p className="text-sm text-gray-600 pt-2">
            ...
            dignissimos! {form.username.length}/50
          </p>
          <section className="pt-[1rem] text-sm">
            {" "}
            <label className="pb-3 block" htmlFor="">
            ...
            <p className="text-sm text-gray-600 pt-2">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quae,
              dignissimos! {form.bio.length}/160
            </p>
          </section>
        </section>
        {/* footer */}
